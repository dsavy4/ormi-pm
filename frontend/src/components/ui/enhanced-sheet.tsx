...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 text-center sm:text-left border-b bg-card px-6 py-4",
      className
    )}
    {...props}
  />
...
const SheetFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 border-t bg-card px-6 py-4 mt-auto",
      className
    )}
    {...props}
  />
